...
public class IK_manL : MonoBehaviour
{
    ...
    private void Init()
    {
        ...
        for (var i = bones.Length - 1; i >= 0; i--)
        {
            ...
            else
            {
                ...
                bonesLength[i] = (current.position - current.GetChild(0).position).magnitude;
    ...
    private void FastIK()
    {
        ...
        if ((target.position - bonesPositions[0]).magnitude > completeLength)
        {
            ...
            targetPosition = bonesPositions[0] + completeLength * (target.position - bonesPositions[0]).normalized;
        ...
        for (int ite = 0; ite < iterations; ite++)
        {
            ...
            for (int i = bonesPositions.Length - 1; i > 0; i--)
            {
                ...
                if (i == bonesPositions.Length - 1)
                {
                    ...
                    bonesPositions[i] = targetPosition;
                }
                else
                {
            ...
            if ((bonesPositions[bonesPositions.Length - 1] - targetPosition).sqrMagnitude >= delta * delta)
            {
                break;
            }
        }
